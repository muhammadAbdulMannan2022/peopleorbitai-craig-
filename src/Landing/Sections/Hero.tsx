  ...
  return (
    <div className="bg-[url('/heroBg.svg')] w-full h-screen bg-no-repeat bg-cover flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="max-w-7xl w-full flex flex-col-reverse md:flex-row justify-between gap-8 px-5 md:px-0 py-8 md:py-10 h-full ">
          ...
          <div className="flex flex-col justify-center space-y-6 w-full md:w-1/2">
            <div className="gap-0">
              <div className="flex items-center">
                <img
                  src="/logosm.svg"
                  className="md:w-30 w-20 h-20 md:h-30 -ms-2.5"
                  alt="Bot"
                />
                <div>
                  <p className="text-xl font-open-san text-text-2nd ">
                    Latest integration just arrived
                  </p>
                  <h1 className="text-4xl md:text-6xl font-bold text-title-2nd">
                    AI Agents That
                  </h1>
                </div>
              </div>
              <span
                ...
                className="text-4xl md:text-6xl font-bold text-main"
              >
                Empower HR
              </span>
            </div>

            <p className="text-xl text-text-2nd">
