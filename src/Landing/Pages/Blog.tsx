...
export const blogPosts = [
  {
    ...
    excerpt: "Discover how AI agents are transforming productivity and automating routine tasks across industries.",
    banner: "https://images.unsplash.com/photo-1677442136019-21780ecad995?auto=format&fit=crop&q=80&w=1600",
    date: "May 7, 2026",
    content: `
  ...
  },
  {
    ...
    excerpt: "Learn the secrets to crafting the perfect prompt and unlocking the full potential of large language models.",
    banner: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?auto=format&fit=crop&q=80&w=1600",
    date: "May 5, 2026",
    content: `
  ...
  },
  {
    ...
    excerpt: "A deep dive into the importance of fairness, transparency, and accountability in artificial intelligence.",
    ...
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      <div className="relative w-full h-[40vh] md:h-[50vh] bg-[url('https://images.unsplash.com/photo-1555949963-aa79dcee981c?auto=format&fit=crop&q=80&w=1600')] bg-no-repeat bg-cover bg-center">
        ...
        <div className="absolute bottom-0 left-0 w-full">
          <div className=" w-full p-6 md:p-0 md:py-16 max-w-7xl mx-auto text-center md:text-left">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-4 leading-tight">Our Articles</h1>
            <p className="text-lg md:text-xl text-white/80 max-w-2xl">
              Insights, news, and perspectives on the future of AI, productivity, and technology.
            </p>
          </div>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-6 md:px-0 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {blogPosts.map((post) => (
            <Link key={post.id} to={`/articles/${post.id}`} className="group flex flex-col bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              ...
              <div className="p-8 flex flex-col grow">
                <p className="text-sm text-main font-semibold mb-3">{post.date}</p>
                <h2 className="text-2xl font-bold text-[#1a1a2e] mb-4 group-hover:text-main transition-colors">{post.title}</h2>
