...
export default function Sidebar({
  ...
  return (
    <aside
      ...
      ${location.pathname.includes("/dashboard/chat") && "w-[90%] sm:w-[80%] md:w-[20%] md:min-w-[400px]"}
    ...
    >
      ...
      <div className="w-full h-full flex">
        {/* left icons */}
        <div
          className={`${location.pathname.includes("/dashboard/chat") ? "w-[23%]" : "w-full"} bg-dashboardMain flex flex-col items-center gap-3 py-4 px-4 `}
        >
          {[
            { name: "Home", Icon: Home, id: 1, action: "/dashboard/chat" },
            {
              name: "Profile",
              Icon: User,
              id: 2,
        ...
        {location.pathname.includes("/dashboard/chat") && (
          <div className="w-[80%] bg-linear-to-b from-dashboardMain to-[#150A29] relative flex flex-col">
            {/* agent tabs */}
              ...
              <div className="shrink-0">
                <div className="relative flex items-center justify-center flex-col w-full h-[350px] md:h-[400px] overflow-hidden">
                  <img
                    ...
                    className="absolute top-18 sm:top-20 w-[55%] sm:w-[45%] md:w-[40%]
                  h-full object-cover object-top z-20"
                  />
                  {/* circles */}
                  <div
                    className="absolute  z-10 w-40 h-40 sm:w-48 sm:h-48 md:w-52 md:h-52
                  bg-dashboardNotActive/60 -mt-5 md:-mt-10 rounded-full flex items-center justify-center"
                    style={{
                      boxShadow:
                  ...
                  >
                    <div className="flex flex-col items-center text-center">
                      ...
                      <h1 className="text-xs sm:text-sm mb-2 text-gray-300 font-bold">
                        {activeAgent.title}
                      </h1>
                      <p className="text-gray-200 text-xs sm:text-sm line-clamp-3">
